...
public class AssignRequestValidator {
     ...
     */
    public List<String> validateAssignRequest(AssignRequestMessage assignRequestMessage) {
    ...
    private Optional<String> validateReservationIdNotNull(AssignRequestMessage assignRequestMessage) {
        return assignRequestMessage.getReservationId() == null ? Optional.of("reservation id should not be null") : Optional.empty();
    }

    private Optional<String> validateSessionIdNotNull(AssignRequestMessage assignRequestMessage) {
        return assignRequestMessage.getSessionId() == null ? Optional.of("session id should not be null") : Optional.empty();
    }

    private Optional<String> validateServiceRequestIdNotNull(AssignRequestMessage assignRequestMessage) {
        return assignRequestMessage.getServiceRequestId() == null ? Optional.of("service request id should not be null") : Optional.empty();
    }

    private Optional<String> validateReservationIdFormat(AssignRequestMessage assignRequestMessage) {
    ...
    private Optional<String> validateSessionIdFormat(AssignRequestMessage assignRequestMessage) {
    ...
    private Optional<String> validateServiceRequestIdFormat(AssignRequestMessage assignRequestMessage) {
