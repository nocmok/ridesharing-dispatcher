...
ds_name=sys.argv[1]
csv_path=script_dir + "/" + ds_name + "/" + ds_name + "_metrics_per_rps.csv"
png_plot_path=script_dir + "/" + ds_name + "/" + ds_name + "_metrics_per_rps.png"
...
for algo in np.unique(dataset["algo"].values):
	samples = dataset[dataset["algo"] == algo]["rps"].values
