...
dataset = read_csv("ny131_metrics_per_capacity.csv")
...
for algo in np.unique(dataset["algo"].values):
	samples = dataset[dataset["algo"] == algo]["capacity"].values
...
plt.savefig("ny131_metrics_per_capacity.png", dpi=300, bbox_inches="tight", pad_inches=0.2)