...
ds_name=sys.argv[1]
csv_path=script_dir + "/" + ds_name + "/" + ds_name + "_vskt_metrics_per_schedule_size.csv"
png_plot_path=script_dir + "/" + ds_name + "/" + ds_name + "_vskt_metrics_per_schedule_size.png"
...
for algo in np.unique(dataset["algo"].values):
	samples = dataset[dataset["algo"] == algo]["max_schedule_size"].values
