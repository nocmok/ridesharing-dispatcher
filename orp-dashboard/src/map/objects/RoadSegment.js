...
export class RoadSegment extends MapObject {
    ...
    constructor(sourceLatLon, targetLatLon) {
        ...
        let vertices = new Float32Array([
            pivots[0].x, 0.5, pivots[0].z,
            pivots[1].x, 0.5, pivots[1].z,
            pivots[2].x, 0.5, pivots[2].z,

            pivots[2].x, 0.5, pivots[2].z,
            pivots[3].x, 0.5, pivots[3].z,
            pivots[0].x, 0.5, pivots[0].z,
        ])
        ...
        this.model = new Promise((resolve, error) => {
            ...
            source.position.set(sourceXYZ.x, 1, sourceXYZ.z)
            ...
            target.position.set(targetXYZ.x, 1, targetXYZ.z)
