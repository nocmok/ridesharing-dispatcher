...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, VehicleTelemetry> orpTelemetryConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props,
                ...
                new ErrorHandlingDeserializer<>(new JsonDeserializer<>(VehicleTelemetry.class)));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, VehicleTelemetry> orpTelemetryKafkaListenerContainerFactory() {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, VehicleTelemetry>();
