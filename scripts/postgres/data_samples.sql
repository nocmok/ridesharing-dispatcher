...
insert into vehicle_session (session_id, vehicle_id, driver_id, created_at, completed_at, status, total_capacity, residual_capacity, schedule_json, road_start_node_id, road_start_node_lat, road_start_node_lon, road_end_node_id, road_end_node_lat, road_end_node_lon, road_cost, road_progress, lat, lon, distance_scheduled)
    values(0,0,1,now(),null,'PENDING',3,3,'[]', 4, -7.4144788E7, 4.07675E7, 0, -7.4145588E7, 4.0768E7, 2182, 1, -7.4145588E7, 4.0768E7, 0);

insert into vehicle_session (session_id, vehicle_id, driver_id, created_at, completed_at, status, total_capacity, residual_capacity, schedule_json, road_start_node_id, road_start_node_lat, road_start_node_lon, road_end_node_id, road_end_node_lat, road_end_node_lon, road_cost, road_progress, lat, lon, distance_scheduled)
    values(1,1,2,now(),null,'PENDING',3,3,'[]', 5, -7.4147588E7, 4.0769E7, 1, -7.4146388E7, 4.07683E7, 3187, 1, -7.4146388E7, 4.07683E7, 0);

insert into vehicle_session (session_id, vehicle_id, driver_id, created_at, completed_at, status, total_capacity, residual_capacity, schedule_json, road_start_node_id, road_start_node_lat, road_start_node_lon, road_end_node_id, road_end_node_lat, road_end_node_lon, road_cost, road_progress, lat, lon, distance_scheduled)
    values(2,2,3,now(),null,'PENDING',3,3,'[]', 10, -7.4142588E7, 4.07713E7, 2, -7.4143788E7, 4.077E7, 4407, 1, -7.4143788E7, 4.077E7, 0);

insert into vehicle_session (session_id, vehicle_id, driver_id, created_at, completed_at, status, total_capacity, residual_capacity, schedule_json, road_start_node_id, road_start_node_lat, road_start_node_lon, road_end_node_id, road_end_node_lat, road_end_node_lon, road_cost, road_progress, lat, lon, distance_scheduled)
    values(3,3,4,now(),null,'PENDING',3,3,'[]', 11, -7.4147988E7, 4.07661E7, 3, -7.4147388E7, 4.07659E7, 1379, 1, -7.4147388E7, 4.07659E7, 0);

insert into vehicle_session (session_id, vehicle_id, driver_id, created_at, completed_at, status, total_capacity, residual_capacity, schedule_json, road_start_node_id, road_start_node_lat, road_start_node_lon, road_end_node_id, road_end_node_lat, road_end_node_lon, road_cost, road_progress, lat, lon, distance_scheduled)
    values(4,4,5,now(),null,'SERVING',3,3,'[{ "deadline" : "2022-02-07T20:16:10.590791Z", "load" : "1", "nodeId" : "3", "lat" : "-7.4147388E7", "lon" : "4.07659E7", "kind" : "PICKUP", "orderId" : "1" }, { "deadline" : "2022-02-07T20:16:10.590791Z", "load" : "1", "nodeId" : "2", "lat" : "-7.4143788E7", "lon" : "4.077E7", "kind" : "DROPOFF", "orderId" : "1" }]', 11, -7.4147988E7, 4.07661E7, 3, -7.4147388E7, 4.07659E7, 1379, 1, -7.4147388E7, 4.07659E7, 13680);